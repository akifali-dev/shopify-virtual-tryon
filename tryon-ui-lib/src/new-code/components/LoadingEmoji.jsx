...
export const SparkleProgressAnimation = React.memo(
  ({ fillColor = "#000000", progressbar }) => {
    return (
      <div className="flex flex-col gap-6 2xl:gap-8 items-center justify-center w-[300px] min-400:w-[350px]">
        ...
        {/* Progress bar */}
        <div className="w-full h-1.5 bg-[#BCBCBC] rounded-full">
          <div
            className="bg-black/90 h-full rounded-full transition-all relative w-full"
            style={{ width: `${progressbar}%` }}
          >
            <div className="absolute -right-3 -top-[9px] rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
